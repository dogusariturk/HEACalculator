...
class Ui_ParametersPage(object):
    ...
    def setupUi(self, ParametersPage):
        ...
        self.resultsTreeWidget.headerItem().setTextAlignment(25, QtCore.Qt.AlignmentFlag.AlignCenter)
    ...
    def retranslateUi(self, ParametersPage):
        ...
        self.resultsTreeWidget.headerItem().setText(12, _translate("ParametersPage", "Mixing Enthalpy"))
        self.resultsTreeWidget.headerItem().setToolTip(
            12,
            _translate("ParametersPage", "<html><head/><body><p>kJ/mol</p></body></html>"),
        )
        self.resultsTreeWidget.headerItem().setText(13, _translate("ParametersPage", "Mixing Entropy"))
        self.resultsTreeWidget.headerItem().setToolTip(
            13,
            _translate("ParametersPage", "<html><head/><body><p>J/K.mol</p></body></html>"),
        )

        self.resultsTreeWidget.headerItem().setText(14, _translate("ParametersPage", "Formation Enthalpy"))
        self.resultsTreeWidget.headerItem().setToolTip(
            14,
            _translate("ParametersPage", "<html><head/><body><p>meV/atom</p></body></html>"),
        )

        self.resultsTreeWidget.headerItem().setText(15, _translate("ParametersPage", "Min. Formation Enthalpy"))
        self.resultsTreeWidget.headerItem().setToolTip(
            15,
            _translate("ParametersPage", "<html><head/><body><p>meV/atom</p></body></html>"),
        )
        ...
        self.resultsTreeWidget.headerItem().setText(18, _translate("ParametersPage", "Model 1"))
        self.resultsTreeWidget.headerItem().setText(19, _translate("ParametersPage", "Model 2"))
        self.resultsTreeWidget.headerItem().setText(20, _translate("ParametersPage", "Model 3"))
        self.resultsTreeWidget.headerItem().setText(21, _translate("ParametersPage", "Model 4"))
        self.resultsTreeWidget.headerItem().setText(22, _translate("ParametersPage", "Model 5"))
        self.resultsTreeWidget.headerItem().setText(23, _translate("ParametersPage", "Model 6"))
        self.resultsTreeWidget.headerItem().setText(24, _translate("ParametersPage", "Model 7"))
        self.resultsTreeWidget.headerItem().setText(25, _translate("ParametersPage", "Model 8"))
