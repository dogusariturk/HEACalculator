...
class Ui_BatchCalculationsPage(object):
    ...
    def retranslateUi(self, BatchCalculationsPage):
        ...
        hi.setText(10, _translate("BatchCalculationsPage", "Mixing Enthalpy"))
        hi.setToolTip(10, _translate("BatchCalculationsPage", "<html><head/><body><p>kJ/mol</p></body></html>"))
        hi.setText(11, _translate("BatchCalculationsPage", "Mixing Entropy"))
        hi.setToolTip(11, _translate("BatchCalculationsPage", "<html><head/><body><p>J/K.mol</p></body></html>"))
        hi.setText(12, _translate("BatchCalculationsPage", "Formation Enthalpy"))
        hi.setToolTip(12, _translate("BatchCalculationsPage", "<html><head/><body><p>meV/atom</p></body></html>"))
        hi.setText(13, _translate("BatchCalculationsPage", "Min. Formation Enthalpy"))
        hi.setToolTip(13, _translate("BatchCalculationsPage", "<html><head/><body><p>meV/atom</p></body></html>"))
        hi.setText(14, _translate("BatchCalculationsPage", "Melting Temperature"))
        hi.setToolTip(14, _translate("BatchCalculationsPage", "<html><head/><body><p>K</p></body></html>"))
        hi.setText(15, _translate("BatchCalculationsPage", "Crystal Structure"))
        hi.setText(16, _translate("BatchCalculationsPage", "Model 1"))
        hi.setText(17, _translate("BatchCalculationsPage", "Model 2"))
        hi.setText(18, _translate("BatchCalculationsPage", "Model 3"))
        hi.setText(19, _translate("BatchCalculationsPage", "Model 4"))
        hi.setText(20, _translate("BatchCalculationsPage", "Model 5"))
        hi.setText(21, _translate("BatchCalculationsPage", "Model 6"))
        hi.setText(22, _translate("BatchCalculationsPage", "Model 7"))
        hi.setText(23, _translate("BatchCalculationsPage", "Model 8"))
