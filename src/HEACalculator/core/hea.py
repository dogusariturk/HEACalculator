...
class HEACalculator:
    ...
    def __str__(self) -> str:
        ...
        return (
            ...
            f"{'Model 1':25}:     {p.model_1}\n"
            f"{'Model 2':25}:     {p.model_2}\n"
            f"{'Model 3':25}:     {p.model_3}\n"
            f"{'Model 4':25}:     {p.model_4}\n"
            f"{'Model 5':25}:     {p.model_5}\n"
            f"{'Model 6':25}:     {p.model_6}\n"
            f"{'Model 7':25}:     {p.model_7()}\n"
            f"{'Model 8':25}:     {p.model_8}\n"
        )
