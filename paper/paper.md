...
The test suite checks every model against the table of the paper that introduced it, about 300 compositions in all. The descriptors reproduce the published values closely, and the criteria return the published phase label for roughly nine alloys in ten.
