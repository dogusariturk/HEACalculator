...
High Entropy Alloys (HEAs) are a class of metallic materials composed of five or more principal elements in near-equimolar ratios (typically 5–35 at% each). Unlike conventional alloys that centre on one or two base metals, HEAs exploit the configurational entropy of mixing to stabilise single-phase disordered solid solutions over intermetallic compounds, often yielding exceptional combinations of mechanical strength, hardness, and corrosion resistance.
...
| 8     | King *et al.* (2016)        | $\phi = \Delta G_{\text{SS}} / (-                                                                 | \Delta G_{\max} |) \geq 1$ | [11](#fn:11) |
